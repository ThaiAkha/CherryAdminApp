...
export const useAdminDatabase = () => {
    ...
    useEffect(() => {
        const loadMeta = async () => {
            const meta = await contentService.getPageMetadata('admin-database');
            if (meta) {
                setPageHeader(meta.titleMain || 'System Database', meta.description || 'Raw data explorer');
            } else {
                setPageHeader('System Database', 'Raw data explorer and maintenance hub.');
            }
        };
        loadMeta();
        fetchTableData(selectedTable);
    }, [selectedTable, setPageHeader, fetchTableData]);
