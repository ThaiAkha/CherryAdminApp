        ...
        <div className="flex flex-col gap-4">
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full h-12 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-3 text-sm font-bold uppercase outline-none focus:border-brand-500 transition-colors"
                />
            </div>
