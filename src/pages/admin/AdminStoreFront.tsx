...
const AdminStoreFront: React.FC<{ onNavigate: (p: string) => void }> = ({ onNavigate: _onNavigate }) => {
  // --- STATE ---
  ...
  // --- 4. RENDER ---
  return (
    <div className="h-[calc(100vh-100px)] grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in duration-500 relative">
