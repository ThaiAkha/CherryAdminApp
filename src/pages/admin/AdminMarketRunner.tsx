...
const AdminMarketRunner: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)] relative bg-gray-50 dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800">
      {/* ================= STICKY HEADER ================= */}
