...
const Calendar: React.FC = () => {
    ...
    return (
        <div className="w-full h-[calc(100vh-120px)] flex flex-col font-sans select-none bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-2xl overflow-hidden shadow-sm border border-gray-200 dark:border-gray-800">
