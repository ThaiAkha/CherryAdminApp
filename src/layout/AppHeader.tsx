...
const AppHeader: React.FC = () => {
  ...
  useEffect(() => {
    const fetchMetadata = async () => {
      // Extract slug from pathname (e.g., "/booking-overview" -> "booking-overview")
      const slug = location.pathname.substring(1) || "home";

      // Don't auto-fetch metadata for pages that handle it themselves
      const manualPages = ['agency-news', 'agency-rates', 'agency-terms', 'agency-assets', 'agency-portal', 'agency-dashboard'];
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        >
          <div className="flex items-center gap-4">
            {actions && (
              <div className="flex items-center gap-2 mr-4 pr-4 border-r border-gray-100 dark:border-gray-800">
                {actions}
              </div>
            )}
